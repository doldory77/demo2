...
CREATE TABLE file(
		...
		file_real_path						varchar(100)  NOT NULL COMMENT '파일물리경로',
		file_path							varchar(100)  NOT NULL COMMENT '파일URL경로',
		file_nm								varchar(100)  NOT NULL COMMENT '신규파일명',
		file_org_nm							varchar(100)  NULL COMMENT '오리지널파일명'
) COMMENT='파일(이미지,문서 등)';
